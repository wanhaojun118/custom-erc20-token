...
contract("NewToken", function (accounts) {
  ...
  it("initializes the contract with the correct values", function () {
    return NewToken.deployed()
      ...
      .then(function (name) {
        assert.equal(name, "New Token", "has the correct name");
      ...
      .then(function (standard) {
        assert.equal(standard, "New Token v1.0", "has the correct standard");
      });
  });
  ...
  it("transfers token ownership", function () {
    return NewToken.deployed()
      .then(function (instance) {
        tokenInstance = instance;
        return tokenInstance.transfer.call(accounts[1], 9999999999999999); // Using .call doesn't creates a transaction
      })
      .then(assert.fail)
      .catch(function (error) {
        assert(
          error.reason.indexOf("invalid number value") >= 0,
          "error message must contains revert."
        );
      ...
      .then(function (success) {
        ...
        // Without using .call will actually creates a transaction

...
contract Curve500Staking {
    ...
    function addStake(address _stakeholder, uint256 _amount) public returns (bool _success) {
        ...
        _success = (CurveInstance.transferFrom(_stakeholder, address(this), _amount));
        ...
        public returns (bool _success)
    {
        ...
        _success = (CurveInstance.transfer(_stakeholder, _amount));
    ...
    function harvestInterest(address _stakeholder, uint256 _amount) public returns (bool _success) {
        ...
        require(_success, "[HarvestInterest failure] - Insufficient balance in Curve500 staking pool");

        _success = (_amount > 0);
        require(_success, "[HarvestInterest failure] - Cannot harvest 0 CRV token");
        ...
        require(_success, "[HarvestInterest failure] - Transfer failed on Curve contract");
